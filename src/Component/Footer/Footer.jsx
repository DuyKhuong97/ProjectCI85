        ...
        <footer>
                ...
                <div className="container">
                    <div className="mail-row">
                        <div className="link-social">
                            <a className="fb" href="https://www.facebook.com/sapowebvietnam/" title="Theo dõi trên Facebook">
                                <svg xmlns="http://www.w3.org/2000/svg" width={36} height={36} viewBox="0 0 36 36" fill="none">
                                    <g clipPath="url(#clip0_121_358)">
                            ...
                            <a className="mes" href="https://www.messenger.com/" title="Theo dõi trên Messenger">
                                <svg xmlns="http://www.w3.org/2000/svg" width={36} height={36} viewBox="0 0 36 36" fill="none">
                        ...
                        <div className="mail-text">
                            <svg xmlns="http://www.w3.org/2000/svg" width={63} height={36} viewBox="0 0 63 36" fill="none">
                                <g clipPath="url(#clip0_131_4747)">
                                    <path d="M12.7695 2.04199L59.664 2.31247L36.2851 22.598C36.2851 22.598 30.2695 21.1104 12.2227 2.17723" fill="white" />
                                    <path d="M12.7695 2.04199L59.664 2.31247L36.2851 22.598C36.2851 22.598 30.2695 21.1104 12.2227 2.17723" stroke="black" strokeMiterlimit={10} />
                        ...
                        <div className="email">
                            <form className="newletter-form">
                                <input type="email" className="email__input" placeholder="Nhập email ưu đãi" />
                                <button className="btn email-btn slider--button">Đăng ký</button>
                            </form>
                        </div>
                    </div>
                </div>
            ...
            <div>
                <div className="info-footer">
                    <div className="info-logo__ft ft">
                        <img className="navbar-brand ft-logo" src="https://firebasestorage.googleapis.com/v0/b/projectci85.appspot.com/o/IMG%2FMain-logo.png?alt=media&token=cb72e1c0-a26b-425a-b20c-2eecbb842091" alt="navbar-logo" />
                        <div className="ft-item">
                            <div className="item-ft ft word-ft">
                                <div className="item">
                            ...
                            <div className="item-ft word-ft">
                                ...
                                <a href="mailto:support@sapo.vn">support@hkt.vn</a>
                            </div>
                            <div className="item-ft word-ft">
                                <div className="item">
                                    <svg xmlns="http://www.w3.org/2000/svg" width={18} height={18} viewBox="0 0 18 18" fill="none">
                                        <g clipPath="url(#clip0_151_819)">
                                ...
                                <a className="tel" href="tel:19006750">1900 0000</a>
                            </div>
                            <div className="item-ft word-ft">
                                <div className="item">
                                    <svg xmlns="http://www.w3.org/2000/svg" width={24} height={24} viewBox="0 0 24 24" fill="none">
                                ...
                                <a href="#" className="system">Địa chỉ cửa hàng</a>
                            </div>
                        </div>
                    </div>
                    <div className="ft1 ft">
                        <h4 className="ft-title">
                            HỖ TRỢ KHÁCH HÀNG
                        </h4>
                        <div className="htkh word-ft p-ft">
                            <a href="#">Trang chủ</a>
                            <a href="#">Giới thiệu</a>
                            <a href="#">Sản phẩm</a>
                            <a href="#">Liên hệ</a>
                    ...
                    <div className="ft3 ft">
                        <div className="word-ft">
                            <h4 className="ft-title">
                                GIỜ MỞ CỬA
                            </h4>
                            <p className="time p-ft">Từ 9:00 - 21:30 tất cả các ngày trong tuần (bao gồm cả các ngày lễ, ngày Tết).</p>
                        </div>
                        <div className="word-ft">
                            <h4 className="ft-title">
                                GÓP Ý, KHIẾU NẠI
            ...
            <div className="Copyright-ft">
                © Bản quyền thuộc về HKT Team | Cung cấp bởi HKT team
            </div>
            <div>
                <a href="#" className="backtop hide" title="Lên đầu trang"><svg aria-hidden="true" style={{scale: 1.2}} focusable="false" data-prefix="far" data-icon="angle-up" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 320 512" className="svg-inline--fa fa-angle-up fa-w-10"><path fill="currentColor" d="M168.5 164.2l148 146.8c4.7 4.7 4.7 12.3 0 17l-19.8 19.8c-4.7 4.7-12.3 4.7-17 0L160 229.3 40.3 347.8c-4.7 4.7-12.3 4.7-17 0L3.5 328c-4.7-4.7-4.7-12.3 0-17l148-146.8c4.7-4.7 12.3-4.7 17 0z" ></path></svg>
                </a>
            </div>
