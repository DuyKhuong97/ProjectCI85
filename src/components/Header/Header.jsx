...
const Header = () => {
    return (
        <header className="header__page">
            <div className="header topbar header-menu order-lg-2 order-1">
                    ...
                    <div className="row navbar-menu">
                        ...
                        <div className="d-flex justify-content-start align-items-center col-lg-7 col-md-12 col-menu order-2 order-lg-1">
                            <ul className="nav-menu">
                                ...
                                <li className="nav-item">
                                    <a href="./HTML/produce.html">GIỚI THIỆU</a>
                                </li>
                                <li className="nav-item dropdown__select">
                                    <a className="dropdown-toggle" href="./HTML/product.html" role="button" aria-expanded="false">
                                        SẢN PHẨM
                                    </a>
                                    <ul className="dropdown__list dropdown__list1">
                                        <li className="dropdown__select1">
                                            <a className="dropdown__list--item" href="#">
                                                <span>Kem dưỡng da</span>
                                                <i className="fa fa-caret-right" />
                                            </a>
                                            <ul className="dropdown__list dropdown__list2">
                                                <li>
                                                    <a className="dropdown__list--item " href="./HTML/detailProduct.html">Bioaqua</a>
                                                </li>
                                                <li>
                                                    <a className="dropdown__list--item " href="#">V7 Tonight Light</a>
                                                </li>
                                                <li>
                                                    <a className="dropdown__list--item " href="#">Collagen</a>
                                                </li>
                                            </ul>
                                        </li>
                                        <li>
                                ...
                                <li className="nav-item">
                                    <a className="disabled" href="./HTML/contact.html">LIÊN HỆ</a>
                                </li>
                                <li className="nav-item">
                                    <a className="disabled" href="./HTML/news.html">TIN TỨC</a>
                                </li>
                            </ul>
                        </div>
                        <div className="navbar__icon d-flex justify-content-end align-items-center col-lg-3 col-md-6 col-7 search-account order-1 order-lg-2">
                            ...
                            <div className="navbar__icon--item">
                                <a href="./HTML/cart.html" className="navbar__icon--item">
                                    ...
                                    <div className="navbar__icon--count-item countItem">0</div>
                                </a>
                            </div>
                        </div>
                    </div>
