...
import SaleCardSlider from "./Sale-Slider/SaleCardSlider"
                ...
                <section className="product-sale">
                    <div className="container">
                        <div className="sale-title">
                            <h2 style={{ marginBottom: '30px' }}><a href="#">KHUYỄN MÃI</a></h2>
                        </div>
                        <div className="sale">

                            <SaleCardSlider />
                        </div>
                        <div className="product-sale__banner">
                            <img src="https://bizweb.dktcdn.net/100/459/658/themes/870139/assets/banner2.jpg?1681183593004" alt="sale banner" />
                        </div>
                    </div>
